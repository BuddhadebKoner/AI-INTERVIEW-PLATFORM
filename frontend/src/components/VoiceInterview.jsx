...
const VoiceInterview = ({ interview }) => {
   ...
   const askQuestion = async index => {
      ...
      try {
         ...
         const languageCode = interview.language === 'english' ? 'en' : interview.language || 'en';
   ...
   const processAnswer = async answerText => {
      try {
         ...
         socket?.emit('answer-submitted', {
            interviewId: interview._id,
            questionNumber: interview.questions[currentQuestionIndex].questionNumber,
            answer: answerText,
         });

         // Analyze answer using Gemini
         const analysisResponse = await axios.post(`${PYTHON_API_URL}/analyze-answer`, {
            question: interview.questions[currentQuestionIndex].question,
            answer: answerText,
            expectedAnswer: interview.questions[currentQuestionIndex].expectedAnswer,
         });
               ...
               <CardContent className="space-y-4">
                  <div className="bg-blue-50 p-4 rounded-lg">
                     ...
                     <ul className="space-y-1 text-sm">
                        ...
                        <li>• <strong>Questions:</strong> {interview?.questions?.length}</li>
                        <li>• <strong>Language:</strong> {interview?.language}</li>
                        <li>• <strong>Complexity:</strong> {interview?.complexity}</li>
                     </ul>
                  </div>

                  <div className="bg-yellow-50 p-4 rounded-lg">
                     <h3 className="font-semibold mb-2">⚠️ Before You Start</h3>
                     <ul className="space-y-1 text-sm">
      ...
      return (
         <div className="max-w-4xl mx-auto p-6">
            <Card>
               ...
               <CardContent>
                  <p className="mb-4">You have completed all {interview.questions.length} questions.</p>
                  ...
                  <div className="space-y-4">
                     ...
                     {answers.map((ans, idx) => (
                        <Card key={idx}>
                           <CardHeader>
                              <CardTitle className="text-sm">Question {ans.questionNumber}</CardTitle>
                           </CardHeader>
                           <CardContent>
                              ...
                              <div className="bg-gray-50 p-3 rounded">
                                 ...
                                 <p className="text-sm mt-1">{ans.analysis.feedback}</p>
                              </div>
                           </CardContent>
                        </Card>
                     ))}
   ...
   return (
      <div className="max-w-4xl mx-auto p-6">
                        ...
                        <div className="flex justify-center space-x-4">
                           {!isRecording ? (
                              ...
                              >
                                 ...
                                 <span>
                                    {micPermission === 'denied' ? 'Microphone Blocked' : 'Start Recording Answer'}
                                 </span>
                              </Button>
                           ) : (
                              <Button
                  ...
                  {isRecording && (
                     <div className="space-y-2">
                        <div className="flex items-center justify-center p-4 bg-red-50 rounded-lg">
                           ...
                           <span>Recording... Speak your answer (Click "Stop Recording" when done)</span>
                        </div>
                        {interimTranscript && (
                           <Card className="bg-blue-50 border-blue-200">
                              <CardContent className="pt-4">
                                 <p className="text-sm text-gray-600 mb-1 font-semibold">Live Transcript:</p>
         ...
         <div className="text-center text-sm text-gray-500">
            <p>Progress: {answers.length} of {interview.questions.length} questions answered</p>
         </div>
      </div>
   );
};
