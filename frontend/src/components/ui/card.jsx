...
const Card = React.forwardRef(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn(
      'bg-card/80 text-card-foreground rounded-3xl border border-border/70 shadow-lg shadow-slate-200/60 backdrop-blur-sm transition-all duration-500 hover:-translate-y-1 hover:shadow-2xl',
      className,
    )}
    {...props}
  />
