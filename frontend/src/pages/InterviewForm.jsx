...
const InterviewForm = () => {
   ...
   const validateStep1 = () => {
      return formData.fullName && formData.email && formData.phone && formData.city && formData.state && isPhoneVerified
   }

   const validateStep2 = () => {
      return formData.position && formData.experience && formData.education && formData.skills
   }
   ...
   const handleSubmit = (e) => {
      ...
      if (validateStep3()) {
         ...
         localStorage.setItem('interviewData', JSON.stringify({
            ...
            identityCard: formData.identityCard ? { name: formData.identityCard.name, size: formData.identityCard.size } : null
         }))
         navigate('/interview')
      }
   }
   ...
   const renderCurrentStep = () => {
      switch (currentStep) {
         case 1:
            ...
            />
         case 2:
            return <ProfessionalEducation formData={formData} onChange={handleInputChange} />
         case 3:
            return (
               <DocumentUpload
                  formData={formData}
         ...
         <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="text-center mb-8 lg:mb-12">
               ...
               <p className="text-lg lg:text-xl text-slate-600 max-w-3xl mx-auto">
                  Get personalized AI interviews for Web Development, App Development, AI/ML, and Data Science roles
               </p>
            </div>
